...
public class mContentProvider extends ContentProvider {
    private static final String AUTHORITY = "com.example.notety.noteapp.notesprovider";
    private static final String BASE_PATH = "notes";
    public static final Uri CONTENT_URI = Uri.parse("content://" + AUTHORITY + "/" + BASE_PATH);

    // Constant to identify the requested operation
    private static final int NOTES = 1; //give me the data
    private static final int NOTES_ID = 2; //to deal with a single record
